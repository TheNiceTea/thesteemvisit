...
class StatisticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post statistics_url, params: { statistic: { clicks: @statistic.clicks, post_id: @statistic.post_id, ref: @statistic.ref } }
    end
  ...
  test "should update statistic" do
    patch statistic_url(@statistic), params: { statistic: { clicks: @statistic.clicks, post_id: @statistic.post_id, ref: @statistic.ref } }
